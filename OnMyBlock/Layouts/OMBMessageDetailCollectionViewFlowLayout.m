//
//  OMBMessageDetailCollectionViewFlowLayout.m
//  OnMyBlock
//
...
CGFloat kMessageDetailScrollResistance = 1500.0f;

@implementation OMBMessageDetailCollectionViewFlowLayout
    ...
    ^(UICollectionViewLayoutAttributes *attribute, NSUInteger idx, BOOL *stop) {
      ...
      if (!CGPointEqualToPoint(CGPointZero, touchLocation)) {
        ...
        CGFloat scrollResistance = distanceFromTouch /
          kMessageDetailScrollResistance;
        if (_latestDelta < 0)

...
return [[OMBNavigationController alloc] initWithRootViewController:[[OMBAccountViewController alloc] init]];
}

// Intro
- (OMBIntroStillImagesViewController*)introViewController {
    return [[OMBIntroStillImagesViewController alloc] init];
}
// Login
- (OMBLoginViewController*)loginViewController {
        return  [[OMBLoginViewController alloc] init];
}
// Payout Methods
- (OMBPayoutMethodsViewController*)payoutMethodsViewController {
    return [[OMBPayoutMethodsViewController alloc] init];
}

- (OMBNavigationController*)payoutMethodsNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:self.payoutMethodsViewController];
}
// Renter Application
- (OMBRenterApplicationViewController*)renterApplicationViewController {
    return [[OMBRenterApplicationViewController alloc] init];
}

// Renter profile
- (OMBRenterProfileViewController*)renterProfileViewController {
    return [[OMBRenterProfileViewController alloc] init];
}

- (OMBNavigationController*)renterProfileNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:self.renterProfileViewController];
}

// My renter profile
- (OMBMyRenterProfileViewController*)myRenterProfileViewController {
    return [[OMBMyRenterProfileViewController alloc] init];
}

- (OMBNavigationController*)myRenterProfileNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:self.myRenterProfileViewController];
}

// Renter
// Search and discover are in the method showDiscover
- (OMBNavigationController*)mapNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController: [[OMBMapViewController alloc] init]];
}

// Search
- (OMBMapFilterViewController*)mapFilterViewController {
    return [[OMBMapFilterViewController alloc] init];
}

- (OMBNavigationController*)mapFilterNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:self.mapFilterViewController];
}

// Favorites
- (OMBNavigationController*)favoritesNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:[[OMBFavoritesListViewController alloc] init]];
}

// Homebase
- (OMBNavigationController*)homebaseRenterNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:[[OMBHomebaseRenterViewController alloc] init]];
}

// Inbox
- (OMBNavigationController*)inboxNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:[[OMBInboxViewController alloc] init]];
}
...
- (OMBNavigationController*)homebaseLandlordNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:[[OMBHomebaseLandlordViewController alloc] init]];
}

// Manage Listings
- (OMBNavigationController*)manageListingsNavigationController {
    return [[OMBNavigationController alloc] initWithRootViewController:[[OMBManageListingsViewController alloc] init]];
}
